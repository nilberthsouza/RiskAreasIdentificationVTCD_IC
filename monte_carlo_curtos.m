%% Alimentando os curtos com monte carlo , sem gerar valores aleatorios e comparando etc.

%--------- PROGRAMA PRINCIPAL DE LOCALIZAÇÃO DE FALTAS EM REDES RADIAIS
%--------- UTILIZANDO ALGORITMO CLONAL COM MATRIZ DE CURTOS FORNECIDA DIRETAMENTE
clear; clc;
...
for m = 1:M
    ...
    for j = 1:N
        tensoes_barra = Tens_Med(j, :);
        % Verifica se há VTCD nas condições de tensão entre 0.1-0.9 ou 1.1-1.8 p.u.
...
disp('Matriz de classificação de VTCD para cada falta real:');
